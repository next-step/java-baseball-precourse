...
public class ValidatorTest {
	...
	static private Stream<Arguments> provideFailTestData() {
		return Stream.of(
			Arguments.of("1", MessageType.INVALID_DIGITS.getMessage()),
			Arguments.of("012", MessageType.INVALID_RANGE_OF_NUMBER.getMessage()),
			Arguments.of("a12", MessageType.INVALID_RANGE_OF_NUMBER.getMessage()),
			Arguments.of("111", MessageType.DUPLICATED_NUMBER.getMessage()));
	}
