...
public class SetTest {
    ...
    @ParameterizedTest
    @DisplayName("numbers 셋에 {0} 이 들어있다 - ValueSource 활용한 ParameterizedTest")
    ...
    @ParameterizedTest
    @DisplayName("numbers 셋에 {0} 이 들어있지 않다 - ValueSource 활용한 ParameterizedTest")
    ...
    @ParameterizedTest
    @DisplayName("numbers 셋에 {0} 이 들어있다 - CsvSource 활용한 ParameterizedTest")
    ...
    @ParameterizedTest
    @DisplayName("numbers 셋에 {0} 이 들어있지 않다 - CsvSource 활용한 ParameterizedTest")
