...
public class AnswerMakerTest {
    ...
    void test_only_number_can_be_answer(String answer) {
    ...
    void test_only_three_numbers_can_be_answer(String answer) {
        assertThat(isValid(answer)).isFalse();
    }
    ...
    void test_every_characters_should_be_unique_and_not_zero(String answer) {
