...
public class BaseballView {
	...
	private static final String NUMBER_INPUT_ERROR_MESSAGE = "[ERROR] 올바른 숫자를 입력해주세요. 중복된 숫자가 없는 세 자리 자연수를 입력해야 합니다.";
	private static final String GAME_OVER_INPUT_ERROR_MESSAGE = "[ERROR] 잘못 입력하셨습니다. " + ENDING_MESSAGE;
	...
	public void showNumberInputErrorMessage() {
		System.out.println(NUMBER_INPUT_ERROR_MESSAGE);
	}

	public void showGameOverInputErrorMessage() {
		System.out.println(GAME_OVER_INPUT_ERROR_MESSAGE);
	}
