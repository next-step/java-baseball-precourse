...
### 요구사항 1 (제약사항)
- [ ] 정상적으로 실행이 되는가
- [ ] 컴퓨터가 임의 숫자를 제대로 생성 하는가

### 요구사항 2 (제약사항)
- [ ] Java Coding Convention Rule은 제대로 따랐는가.
- [ ] indent의 depth가 2를 넘지 않는가.
- [ ] stream api 를 사용하지 않았는가.
- [ ] else를 사용 안하였는가
- [ ] 함수(메소드)의 길이가 10이 넘어가지 않는가

### 요구사항 3 (단위 테스트)
- [ ] 도메인 로직에 단위 테스트를 구현해야 한다.
- [ ] JUnit5 기반 테스트를 구현하였는가 .(학습하였는가)