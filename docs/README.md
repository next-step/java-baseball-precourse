...
- [x] 볼 1개에 대한 판정
  - [x] 숫자, 자리가 일치하면 스트라이크
  - [x] 숫자만 일치하면 볼
  - [x] 숫자, 자리가 모두 일치하지 않으면 낫싱
- [x] 볼 3개에 대한 판정
- [x] 숫자 생성 전략
  - [x] 1부터 9까지 서로 다른 임의의 수 3개를 생성
- [x] 판정에 대한 결과 생성
  - [x] 스트라이크, 볼, 낫싱 확인
  - [x] 게임 종료(3스트라이크) 여부 확인
- [x] 야구 게임 기능
  - [x] 게임을 시작하면 컴퓨터 임의의 수 생성
  - [x] 숫자 3개를 입력 받아서 결과 반환
  - [x] 3개의 숫자가 모두 맞지 않으면 입력 반복
  - [x] 재시작을 선택하면 컴퓨터 임의의 수 다시 생성
- [x] 사용자 입력
  - [x] 1부터 9까지 서로 다른 수 3개 입력
  - [x] 3개의 숫자를 모두 맞히면 재시작(1) 또는 종료(2) 입력
  - [x] 잘못된 값을 입력할 경우 IllegalArgumentException 발생 후 애플리케이션 종료
- [x] 결과 출력
  - [x] 사용자 입력 값에 대한 결과 출력(예: 낫싱, 1볼, 1볼 1스트라이크, 3스트라이크)
  - [x] 3개의 숫자를 모두 맞히면 게임 종료 메시지 출력
